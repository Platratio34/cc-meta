...
---Diamond pickaxes (mining turtles) can break any vanilla block, but other tools (such as axes) are more limited.
---
---@param side? "left"|"right" The specific tool to use.
---@return boolean broken Whether a block was broken.
...
---@return boolean broken Whether a block was broken.
---@return string|nil reason The reason no block was broken.
function turtle.gidDown(side) end
...
---@return boolean placed Whether the block could be placed.
...
---@return boolean dropped Whether items were dropped.
---@return string|nil reason The reason the no items were dropped.
...
---@return true selected When the slot has been selected.
...
---
---@return boolean solid If there is a solid block in front.
function turtle.detect() end

---Check if there is a solid block above the turtle.
---In this case, solid refers to any non-air or liquid block.
---
---@return boolean solid If there is a solid block above.
function turtle.detectUp() end

---Check if there is a solid block below the turtle.
---In this case, solid refers to any non-air or liquid block.
---
---@return boolean solid If there is a solid block below.
...
---@return string|nil reason The reason nothing was attacked.
...
---@return string|nil reason The reason the no items were picked up.
...
---@return number|"unlimited" level The current amount of fuel a turtle this turtle has. **OR** `"unlimited"` If turtles do not consume fuel when moving.
...
---This finishes once the turtle is fully refueled or all items have been consumed.
---
---@param count? integer The maximum number of items to consume. One can pass `0` to check if an item is combustible or not.
---@return boolean refueled If the turtle was refueled.
---@return string|nil reason The reason the turtle was not refueled.
function turtle.refuel(count) end

---Compare the item in the currently selected slot to the item in another slot.
---@param slot integer The slot to compare to.
...
---@param slot integer The slot to move this item to.
...
---
---@return integer|"unlimited" limit The maximum amount of fuel a turtle can hold. **OR** `"unlimited"` If turtles do not consume fuel when moving.
...
---
---@return boolean equipped If the item was equipped.
---@return string|nil reason The reason equipping this item failed.
...
---@return boolean present Whether there is a block in front of the turtle.
---@return table|string block Information about the block in front, or a message explaining that there is no block.
function turtle.inspect() end

---Get information about the block above the turtle.
---@return boolean present Whether there is a block above the turtle.
---@return table|string block Information about the block above, or a message explaining that there is no block.
function turtle.inspectUp() end

---Get information about the block below the turtle.
---@return boolean present Whether there is a block below the turtle.
---@return table|string block Information about the block below, or a message explaining that there is no block.
...
---@return table|nil item Information about the given slot, or `nil` if it is empty.
