...
peripheral = {} --- CC Peripheral module
...
---
---@return string[] names A list of the names of all attached peripherals.
...
---@return string...? types The peripheral's types, or `nil` if it is not present.
...
---@return boolean? present If a peripheral has a particular type, or `nil` if it is not present.
...
---@return any rt The return values of the peripheral method.
...
---@return table? peripheral The table containing the peripheral's methods, or nil if there is no peripheral present with the given name.
