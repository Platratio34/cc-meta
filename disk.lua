...
---@param name string The name of the disk drive
---@return boolean present If the disk is present and provides a mount.
...
---
---@param name string The name of the disk drive
---@return boolean audio If the disk is present and has audio saved on it.
